...
public class ForgerockToken {
    ...
    @Inject
    public ForgerockToken(HttpConnectionClient httpConnectionClient) {
        this.httpConnectionClient = httpConnectionClient;
    }

    public Boolean createToken(String adminUsername, String adminPassword, TreeContext context) {
        ...
        try (CloseableHttpClient httpClient = httpConnectionClient.getHttpClient(context)) {
            HttpPost httpPost = httpConnectionClient.createPostRequest(hostUrl + Constants.FORGEROCK_GET_TOKEN_URL);
