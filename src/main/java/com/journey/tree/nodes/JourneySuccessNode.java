/**
 * @author Sacumen(www.sacumen.com) JourneySuccessNode node with
 * single outcome. This node will display enrollment/authentication success
 * message to the user
 */
...
public class JourneySuccessNode extends SingleOutcomeNode {
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        logger.debug("*********************JourneySuccessNode node********************");
